# VitaView AI — System Inventory (PT)

> Detailed Portuguese inventory of the system, generated from a full repository scan.
> For the executive overview in English, see the root [README.md](../README.md).
...
Este inventário foi gerado a partir de uma varredura do código em **26/02/2026** (frontend, backend, rotas e schema).
