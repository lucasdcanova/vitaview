...
import { PremiumLockTooltip } from "@/components/ui/premium-lock-tooltip";
import {
                            ...
                            {selectedMedInfo ? (
                                <Popover open={suggestionPopoverOpen} onOpenChange={setSuggestionPopoverOpen}>
                                    <PopoverTrigger asChild>
                                        <PremiumLockTooltip
                                            enabled={!isPremium}
                                            description="Sugestões de dose por IA estão disponíveis nos planos Vita."
                                            side="bottom"
                                            align="end"
                                        >
                                            <button
                                                ...
                                                title={isPremium ? "Ver sugestões de dose (IA)" : undefined}
                                                onClick={(e) => {
                                                    if (!isPremium) {
                                                        e.preventDefault();
                                                    }
