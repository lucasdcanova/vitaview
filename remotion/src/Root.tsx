...
import { VitaViewShowcaseVertical } from './VitaViewShowcaseVertical';
...
const DURATION_VERTICAL_30 = 1410;   // 30fps
const DURATION_VERTICAL_60 = 2820;  // 60fps
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      <Composition id="VitaViewShowcase-Vertical" component={VitaViewShowcaseVertical} durationInFrames={DURATION_VERTICAL_30} fps={30} width={VERT_WIDTH} height={VERT_HEIGHT} />
      ...
      <Folder name="4K-60fps">
        ...
        <Composition id="Showcase-Vertical-60fps" component={VitaViewShowcaseVertical} durationInFrames={DURATION_VERTICAL_60} fps={60} width={VERT_WIDTH} height={VERT_HEIGHT} />
      </Folder>
